...
if __name__ == "__main__":
    ...
    SCALE_OUT_PROCESS_NAME = 'Process/Telekom_Malaysia/_py__NS_LCM__NSD_based-on_SOL001_/Process_Scale-in_NS'
    service_id = ''
    service_ext_ref = ''
    ...
    MSA_API.task_success( 'NS Instance SCALE_IN operation is successfully executed.', context, True)
