...
if __name__ == "__main__":
    ...
    try:
        ...
        net = one.virt_net_create(virt_net_name=context['virt_net_name'],
                                  ip_prefix=context['virt_net_ip_prefix'])
        if 'id' in net.keys():
            net_id = net['id']
        else:
            ...
            print(ret)
            exit()
        one.get_status_loop(net_id, '2020-05-01')
        status = one.get_resource_status(net_id, '2020-05-01')
