...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range(int(context['vm_qty'])):
            num = i + 1
            ip_name = context['public_ip_name'] + '-' + str(num) + '-ip'
            fqdn = context['vm_label'] + '-' + str(num)
    ...
    context['pub_ip_id'] = pub_ip_id

    ret = MSA_API.process_content('ENDED', f'{context["vm_qty"]} public IPs Created',
                                  context, True)
    print(ret)