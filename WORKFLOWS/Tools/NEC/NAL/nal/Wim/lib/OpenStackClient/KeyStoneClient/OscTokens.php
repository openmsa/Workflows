...
class OscTokens extends OscClientBase{
    ...
    public function createToken($user_name, $password, $endPoint) {
        ...
        //$param = json_encode(array('auth' => array('passwordCredentials' => array('username' => $user_name, 'password' => $password))));
        $param = json_encode(
                     array(
                         'auth' => array(
                             'identity' => array(
        ...
        try{
            ...
            */
            ...
            /*
            echo "keystone url&param return. ----------------" . "\n";
            var_dump($resp);
            echo "keystone url&param return. ----------------" . "\n";
            */
