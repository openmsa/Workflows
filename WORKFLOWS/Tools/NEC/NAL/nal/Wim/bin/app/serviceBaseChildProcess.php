...
* 2.FUNCTION : serviceBaseChildProcess.php
*/
require_once dirname(__FILE__). '/../NalChildProcess.php';

class serviceBaseChildProcess extends NalChildProcess {
    ...
    protected function checkJobCenterNal( $retry, $max ) {
        ...
        if( $status === neccsNal_Config::JOB_STATUS_DONE ) {
            ...
            $dcChk  = isset( $result['data']['wim_check_'. $this->_p['function_type']] ) ? $result['data']['wim_check_'. $this->_p['function_type']] : '';
