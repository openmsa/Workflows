...
* 2.FUNCTION : serviceSettingChildProcess.php
*/
require_once dirname(__FILE__). '/../NalChildProcess.php';

class serviceSettingChildProcess extends NalChildProcess {
    ...
    protected function checkJobCenterNal( $retry, $max ) {
        ...
        if( $status === neccsNal_Config::JOB_STATUS_DONE ) {
            ...
            $dcChk  = isset( $result['data']['wim_check_serviceSetting'] ) ? $result['data']['wim_check_serviceSetting'] : '';
    ...
    protected function callJobCenterForDb( $method = '' ){
        ...
        $execCmd = "$jcCmd -p $jobParam ". neccsNal_Config::UPDATE_SERVICE_SETTING_FINAL;
    ...
    protected function callJobSchedulerForDb() {
        ...
        $this->jobCenterOperation = neccsNal_Config::UPDATE_SERVICE_SETTING_FINAL;
