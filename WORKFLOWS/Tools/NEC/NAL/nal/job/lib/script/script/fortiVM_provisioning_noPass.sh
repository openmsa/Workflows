...
tftp_server_address = sys.argv[15]
license_file_name = sys.argv[16]
vnf_new_password = sys.argv[17]
default_gateway = sys.argv[18]
default_gateway_device = sys.argv[19]
