...
###### VNF Zero Touch CLI #########
vnf_changemode1 = "configure"
#tftp import license from <host> <filename> <Source path>
vnf_command1 = "tftp import license from " + tftp_server_address + " file " + license_file_name
