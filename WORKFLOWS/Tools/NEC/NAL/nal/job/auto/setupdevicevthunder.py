...
from job.lib.soap.msa import vthunderordercmdws


class SetupDeviceVthunder(base.JobAutoBase):
    ...
    def __setup_system_common_vthunder(self,
        ...
        msa = vthunderordercmdws.VthunderOrderCommandWs(
                                                    self.job_config,
    ...
    def __setup_tenant_vlan_vthunder(self,
        ...
        msa_info['create_vthunder_network_vlan_interface'] = \
