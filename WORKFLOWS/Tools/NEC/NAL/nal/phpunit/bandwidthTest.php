...
require_once dirname(__FILE__) . '/Stub/bandwidthStb.php';

class bandwidthTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var bandwidth
     */
    ...
    public function testPut()
    {
        ...
        // mock
        $stb = $this->getMock('bandwidth',array('execJobNalWim'));
        ...
        // case3
        // mock
        $stb = $this->getMock('bandwidth',array('execJobNalWim', 'checkJobForDbWim'));
        $stb->expects($this->any())->method('execJobNalWim')->will($this->returnArgument(0));
    ...
    /**
     * @covers bandwidth::execJobNalWim
    ...
    public function testExecJobNalWim()
    {
        ...
        // mock
        $stb = $this->getMock('bandwidth',array('callJobScheduler','callJobCenterNalWim'));
    ...
    /**
     * @covers bandwidth::callJobCenterNalWim
    ...
    public function testCallJobCenterNalWim()
    {
        ...
        $ret->jobCenterOperation = "create-bandwidth";
        ...
        $ret->_p['job_out'] = "jc-sv01:nsumsmgr:create-bandwidth.20160706040616.nstrk";
        $this->assertEquals($method->invoke($ret),'');
    ...
    public function testExecApi()
    {
         ...
         // case 2
         $stb = $this->getMock('bandwidth',array('error'));
    ...
    /**
     * @covers bandwidth::checkJobForDbWim
    ...
    public function testCheckJobForDbWim()
    {
        ...
        // case 1
        $stb = $this->getMock('bandwidth',array('_execWimApi'));
        ...
        // case 3
        $stb = $this->getMock('bandwidth',array('_execWimApi','error'));
        ...
        // case 7
        $stb = $this->getMock('bandwidth',array('_execWimApi','_deleteDirectory','success'));
