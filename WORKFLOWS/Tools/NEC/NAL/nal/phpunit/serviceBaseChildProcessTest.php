...
require_once dirname(__FILE__) . '/Stub/serviceBaseChildProcessStb.php';
require_once dirname(__FILE__) . '/../Nal/bin/app/serviceBaseChildProcess.php';

class serviceBaseChildProcessTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var serviceBaseChildProcess
     */
    protected $object;
    ...
    /**
     * @covers serviceBaseChildProcess::post
    ...
    public function testPost(){
        ...
        $ret = new serviceBaseChildProcess( $param );
        ...
        // case 2
        $ret = new serviceBaseChildProcessStb( $param );
        $method = new ReflectionMethod( $ret, 'post' );
        $ret->_p['job-id'] = 'update-serviceBase.20170214004340';
        $method->setAccessible( true );
    ...
    /**
     * @covers serviceBaseChildProcess::put
    ...
    /**
     * @covers serviceBaseChildProcess::delete
    ...
    /**
     * @covers serviceBaseChildProcess::execCheckNal
    ...
    /**
     * @covers serviceBaseChildProcess::checkJobCenterNal
    ...
    /**
     * @covers serviceBaseChildProcess::checkJobSchedulerNal
...
STR;
    ...
    /**
     * @covers serviceBaseChildProcess::_execWimApi
    ...
    /**
     * @covers serviceBaseChildProcess::_makeInFile
    ...
    /**
     * @covers serviceBaseChildProcess::_execResult
