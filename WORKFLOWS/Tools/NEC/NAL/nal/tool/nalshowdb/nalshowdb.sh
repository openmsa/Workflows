...
if [ $# -eq 1 ] ; then
        ...
        tables="NAL_APL_MNG NAL_CONFIG_MNG NAL_DEVICE_ENDPOINT_MNG NAL_GLOBAL_IP_MNG NAL_LICENSE_MNG NAL_MSA_VLAN_MNG NAL_POD_MNG NAL_PORT_MNG NAL_QUOTA_MNG NAL_TENANT_MNG NAL_VIRTUAL_LAN_MNG NAL_VXLANGW_POD_MNG WIM_CONFIG_MNG WIM_DC_CONNECT_GROUP_MNG WIM_DC_CONNECT_MEMBER_MNG WIM_DC_MNG WIM_DC_VLAN_MNG WIM_DEVICE_ENDPOINT_MNG"
        tname="all"
fi
