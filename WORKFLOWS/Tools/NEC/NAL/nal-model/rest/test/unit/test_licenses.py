...
class TestSelectAPI(unittest.TestCase):
    ...
    def create_fixtures(self):
        ...
        cur.execute("INSERT INTO NAL_LICENSE_MNG(create_id, create_date, " +
                    "update_id, update_date, delete_flg, " +
                    "license, extension_info) VALUES " +
                    "(%s, %s, %s, %s, %s, %s, %s)",
                    param_vals)

        cur.execute('SELECT last_insert_id() FROM NAL_LICENSE_MNG')
        global ID
        ID = cur.fetchall()[0][0]
    ...
    def destroy_fixtures(self):
        ...
        cur.execute("DELETE FROM NAL_LICENSE_MNG WHERE " +
    ...
    def test_delete_api(self):
        ...
        cur.execute("SELECT ID FROM NAL_LICENSE_MNG " +
                    "WHERE ID = %s", [ID])
