...
class TestSelectAPI(unittest.TestCase):
    ...
    def create_fixtures(self):
        ...
        extension_info = {
            ...
            'contract_kind': 'contract_kindxxxxxxxxxx',
        ...
        sql = 'INSERT INTO NAL_TENANT_CONTRACT_MNG ' +\
        ...
        cur.execute('SELECT last_insert_id() FROM NAL_TENANT_CONTRACT_MNG')
        global ID
        ID = cur.fetchall()[0][0]
    ...
    def destroy_fixtures(self):
        ...
        cur.execute("DELETE FROM NAL_TENANT_CONTRACT_MNG WHERE " +
    ...
    def test_delete_api(self):
        ...
        cur.execute("SELECT ID FROM NAL_TENANT_CONTRACT_MNG WHERE ID = %s", [ID])
