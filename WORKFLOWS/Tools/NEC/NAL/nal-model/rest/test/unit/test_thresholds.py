...
class TestSelectAPI(unittest.TestCase):
    ...
    def create_fixtures(self):
        ...
        extension_info = {
            'nw_resource_kind': 'nw_resource_kindxxxxxxxxxx',
            'type': 'typexxxxxxxxxx',
            'device_type': 'device_typexxxxxxxxxx',
            'redundant_configuration_flg':
                    'redundant_configuration_flgxxxxxxxxxx',
            'type_detail': 'type_detailxxxxxxxxxx',
            'threshold': 'thresholdxxxxxxxxxx',
        }
        ...
        sql = 'INSERT INTO NAL_THRESHOLD_MNG ' +\
        ...
        cur.execute('SELECT last_insert_id() FROM NAL_THRESHOLD_MNG')
        global ID
        ID = cur.fetchall()[0][0]
    ...
    def destroy_fixtures(self):
        ...
        cur.execute("DELETE FROM NAL_THRESHOLD_MNG WHERE " +
    ...
    def test_delete_api(self):
        ...
        cur.execute("SELECT ID FROM NAL_THRESHOLD_MNG WHERE ID = %s", [ID])
