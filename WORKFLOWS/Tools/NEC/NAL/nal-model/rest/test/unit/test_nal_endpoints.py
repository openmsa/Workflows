...
class TestSelectAPI(unittest.TestCase):
    ...
    def create_fixtures(self):
        ...
        extension_info = {
            ...
            'endpoint_info': '{"aaa":"aaaaaa","bbb":"bbbbbb","ccc":"ccccccc"}',
        }
        ...
        cur.execute("INSERT INTO NAL_DEVICE_ENDPOINT_MNG(" +
        ...
        cur.execute('SELECT last_insert_id() FROM NAL_DEVICE_ENDPOINT_MNG')
        global ID
        ID = cur.fetchall()[0][0]
    ...
    def destroy_fixtures(self):
        ...
        cur.execute("DELETE FROM NAL_DEVICE_ENDPOINT_MNG WHERE " +
    ...
    def test_insert_api(self):
        ...
        insert_params = {
            ...
            'pod_id': 'pod_id_0001',
            'endpoint_info': '{"xxx":"xxxxx","bbb":"bbbbbb","ccc":"ccccccc"}',
        }
        request_params = {
            'body': insert_params,
            'query': {},
    ...
    def test_delete_api(self):
        ...
        cur.execute("SELECT ID FROM NAL_DEVICE_ENDPOINT_MNG " +
                    "WHERE ID = %s", [ID])
