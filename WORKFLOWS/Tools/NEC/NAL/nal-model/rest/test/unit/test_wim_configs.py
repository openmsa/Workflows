...
class TestSelectAPI(unittest.TestCase):
    ...
    def create_fixtures(self):
        ...
        cur.execute("INSERT INTO WIM_CONFIG_MNG(" +
        ...
        cur.execute('SELECT last_insert_id() FROM WIM_CONFIG_MNG')
        global ID
        ID = cur.fetchall()[0][0]
    ...
    def destroy_fixtures(self):
        ...
        cur.execute("DELETE FROM WIM_CONFIG_MNG WHERE " +
    ...
    def test_delete_api(self):
        ...
        cur.execute("SELECT ID FROM WIM_CONFIG_MNG " +
                    "WHERE ID = %s", [ID])
