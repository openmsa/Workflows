...
$context['operation']='Stop VM '.$context['vm_name'].'';

$authorization = 'Authorization: Bearer '.$context['token'].'';
$context['URL']='https://management.azure.com/subscriptions/'.$context['subscription_id'].'/resourceGroups/'.$context['res_gr_name'].'/providers/Microsoft.Compute/virtualMachines/'.$context['vm_name'].'/powerOff?api-version=2017-12-01';
$doc='{}';
