...
PLAN_PROCESS_NAME = 'Process_Plan'
service_id = ''
service_ext_ref = ''
...
if isinstance(data, dict):
    ...
    orch.execute_service_by_reference(ubiqube_id, service_ext_ref, SERVICE_NAME, PLAN_PROCESS_NAME, data)
    response = json.loads(orch.content)
    ...
    if status == constants.FAILED:
        ...
        print(ret)
        sys.exit()
ret = MSA_API.process_content(constants.ENDED, 'Terraform plan is executed successfully.', context, True)
print(ret)
sys.exit()