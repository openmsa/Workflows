...
function list_args()
{
  ...
  create_var_def('playbook_list.0.playbook', 'String');
...
foreach ($context['playbook_list'] as $index => $details) {
  $playbook_attributes_array[] = $details['playbook'];
}

logToFile(debug_dump($playbook_attributes_array, 'DEBUG: PLAYBOOK ATTRIBUTES'));
