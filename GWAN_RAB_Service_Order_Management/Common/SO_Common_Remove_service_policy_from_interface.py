...
if 'ServicePolicy' in context:
    ...
    #ServicePolicy Management WF service name constant variable.
    ...
    service_id = ''
    service_ext_ref = ''
    #Instantiate new ServicePolicy_Management WF dedicated for the device_id.
    ...
    #Loop in ServicePolicy dictionary object by calling the ServicePolicy_Management process 'Add Service Policy'.
