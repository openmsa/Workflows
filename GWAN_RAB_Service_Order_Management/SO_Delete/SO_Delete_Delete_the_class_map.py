...
if 'ClassMap' in context and context['ClassMap']:
    ...
    #Loop in class_map dictionary object by calling the Class_Map_Management process 'Delete Class Map'. 
    ...
    MSA_API.task_success('Class Map deleted successfully to the device ' + device_ref + ' (#' + str(service_id) + ')', context, True)
MSA_API.task_success('No Class Map to be deleted in the device.', context, True)