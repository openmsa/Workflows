...
if 'policyMaps' in context and context['policyMaps']:
    ...
    #execute 'Policy_Map_Management' process 'Delete_Policy_Map' 1 times
...
MSA_API.task_success('No Policy-map configuration to be deleted in the device.', context, True)